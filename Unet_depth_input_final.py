...
if __name__ == "__main__":
    ...
    #     - extrapolation should be UNcommented
    #     - anisotropic blurring and histogram equalization should be commented
    ...
    # # Perform cross-validation with preprocessed images
