## Unet using depth-anything images as input
## Eline van der Hoek
## 14-11-2024
...
from functions import cross_validation_depth, train_final_model_depth_input
...
if __name__ == "__main__":
    ...
    loc_output = "C:\\Users\\ehoek3\\OneDrive - UMC Utrecht\\Tracheomalacie\\Python\\Depth-Anything-V2\\Output_unet_depth_input"
    ...
    #avg_dice_score, pred_masks, pred_masks_all_folds = cross_validation_depth(original_images, rgb_images, depth_images, preprocessed_masks, filenames, loc_output)
    #print(f"Average dice score across all folds: {avg_dice_score}")

    ## Uncomment this if you want to train final model
    #final_model, final_pred_masks, final_dice_score = train_final_model_depth_input(depth_images, preprocessed_masks, filenames, loc_output)
