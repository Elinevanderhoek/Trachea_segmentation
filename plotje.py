...
#     "U-Net": [0.283, 0.290, 0.483, 0.769, 0.840, 0.911],
#     "Depth-Anything": [1.546, 2.579, 1.512, 1.466, 1.604, 1.439],
#     "U-Net using Depth-Anything": [2.237, 1.488, 2.635, 2.895, 1.881, 2.731],
#     "U-Net using two images": [0.337, 0.621, 0.442, 0.671, 0.733, 1.787],
# }
...
# Creating DataFrames
#df_heatmap_Z = pd.DataFrame(heatmap_data_Z).set_index("Metric")
